...
fmap = '../../data/CN3l/en_de/en2de_cn.csv'
fmap2 = '../../data/CN3l/en_de/de2en_cn.csv'
fmodel = '../../models/en_de/model_MMtransE_cn_ed.bin'
ofile1 = '../../results/C_test_en2de_score_MM.txt'
ofile4 = '../../results/C_test_de2en_score_MM.txt'
