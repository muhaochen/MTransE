...
fmodel = os.path.join(os.path.dirname(__file__), '../../models/en_de/model_MMtransE_cn_ed.bin')
ofile1 = os.path.join(os.path.dirname(__file__), '../../results/C_test_en2de_score_MM.txt')
ofile4 = os.path.join(os.path.dirname(__file__), '../../results/C_test_de2en_score_MM.txt')
