...
model = ITransE(dim=50, save_dir=os.path.join(os.path.dirname(__file__), 'model_ItransE_person_cn_ed.bin'))
...
model.save(os.path.join(os.path.dirname(__file__), 'model_ItransE_person_cn_ed.bin'))
